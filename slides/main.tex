...
\begin{frame}{Multiple Noisy Views}
  ...
  \begin{theorem}[Theorem 8 (informal)]
    the proof applies the \textbf{Kolmogorov Strong Law of Large Numbers}:
  given independent random variables with bounded variances, their average converges
...
\begin{frame}{Limitations: Sufficiently Distinct Views (SDV)}
  ...
  \begin{alertblock}{Note}
    The derivation in the paper probably incorrect; use partial derivatives with respect y not t.
  \end{alertblock}
